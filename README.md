...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ndim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11392&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ndim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ndim` can be installed with:

```
conda install ndim
```

It is possible to list all of the versions of `ndim` available on your platform with:
